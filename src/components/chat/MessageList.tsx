          ...
          >
            {message.role === "assistant" && (
              <div className="flex-shrink-0">
                <div className="w-9 h-9 rounded-lg bg-neutral-800 border border-neutral-700 shadow-sm flex items-center justify-center">
                    ...
                    <>
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "reasoning":
                            return (
                              <div key={partIndex} className="mt-3 p-3 bg-neutral-900/50 rounded-md border border-neutral-600">
